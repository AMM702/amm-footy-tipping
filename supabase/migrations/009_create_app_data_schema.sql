-- supabase/migrations/009_create_app_data_schema.sql
-- Purpose: Move all application tables from public to app_data schema for better security and organization
-- Author: GitHub Copilot
-- Date: 2025-12-22
-- 
-- This migration creates a dedicated app_data schema and moves all 9 application tables
-- from the public schema to app_data. Functions are updated to use schema-qualified names.
-- 
-- Tables migrated: users, comps, user_comps, teams, seasons, rounds, games, tips, scores
-- Functions updated: update_updated_at_column, calculate_round_score, update_scores_on_game_result
--
-- Note: Uses ALTER TABLE SET SCHEMA for zero-downtime migration. Table data is preserved.

BEGIN;

-- ============================================================================
-- PHASE 1: Create app_data schema
-- ============================================================================
...
-- Verify all tables are in app_data schema
-- SELECT schemaname, tablename 
-- FROM pg_tables 
-- WHERE schemaname IN ('public', 'app_data') 
-- ORDER BY schemaname, tablename;

-- Verify all functions are in app_data schema
-- SELECT n.nspname as schema, p.proname as function
-- FROM pg_proc p
-- JOIN pg_namespace n ON p.pronamespace = n.oid
-- WHERE n.nspname IN ('public', 'app_data')
-- AND p.proname IN ('update_updated_at_column', 'calculate_round_score', 'update_scores_on_game_result');
...
-- SELECT 'users' as table_name, COUNT(*) FROM app_data.users
